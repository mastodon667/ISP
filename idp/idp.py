...
class IDP(object):
    ...
    def __init__(self):
        ...
        with open('/home/herbert/PycharmProjects/Thesis/idp/inference.txt') as data:
            for line in data:
                name, code = line.split(';')
                self.inferences[name] = code
        self.unsatvoc = ''
        with open('/home/herbert/PycharmProjects/Thesis/idp/unsatvoc.txt') as data:
            for line in data:
                self.unsatvoc += line + '\n'
        self.vocabulary = ''
        with open('/home/herbert/PycharmProjects/Thesis/idp/vocabulary.txt') as data:
            for line in data:
                self.vocabulary += line + '\n'
        self.theory = ''
        with open('/home/herbert/PycharmProjects/Thesis/idp/theory.txt') as data:
            for line in data:
                self.theory += line + '\n'
        self.terms = dict()
        with open('/home/herbert/PycharmProjects/Thesis/idp/terms.txt') as data:
            for line in data:
